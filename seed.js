...
const initData = async () => {
  try {
    ...
    const productsData = [
      ...
      { name: '남성 트리 러너 NZ', price: 170000, discountRate: 30, categories: ['lifestyle'], materials: ['부드럽고 따뜻한 wool'], availableSizes: [250, 260, 270, 280], images: ['/uploads/shoe2_1.png', '/uploads/shoe2_2.png'], description: '최상의 편안함을 위해 세심하게 만들어진 트리 러너 NZ는 메모리폼 풋베드로 다양한 발 형태에도 유연하게 대응해, 누구에게나 안정적인 착화감을 제공합니다.' },
      ...
      { name: '남성 트리 스키퍼', price: 150000, discountRate: 48, categories: ['slip-on'], materials: ['캔버스'], availableSizes: [250, 260, 270], images: ['/uploads/shoe4_1.png', '/uploads/shoe4_2.png'], description: '트리 스키퍼(Tree Skipper)는 편하게 신을 수 있는 보트화 스타일 스니커즈입니다.' },
      ...
      // --- Image 4 ---
      { name: '남성 울 파이퍼', price: 170000, discountRate: 30, categories: ['slip-on', 'lifestyle'], materials: ['부드럽고 따뜻한 wool'], availableSizes: [250, 260, 270], images: ['/uploads/shoe19_1.png', '/uploads/shoe19_2.png'], description: 'Wool Piper는 클래식 로우탑 디자인을 재해석한 데일리 캐주얼슈즈입니다.' },
      ...
      { name: '남성 트리 토퍼', price: 200000, discountRate: 61, categories: ['lifestyle'], materials: ['부드럽고 따뜻한 wool'], availableSizes: [260, 270, 280], images: ['/uploads/shoe33_1.png', '/uploads/shoe33_2.png'], description: 'Tree Topper는 미니멀리스트 하이탑으로 가볍고 통기성이 뛰어난 유칼립투스 나무 섬유로 만들었습니다. 따뜻한 날씨에 적합하며 캐주얼 웨어에 완벽한 데일리 워킹화입니다.' },
      ...
      { name: '남성 트리 파이퍼', price: 170000, discountRate: 54, categories: ['slip-on'], materials: ['플라스틱 제로 식물성 가죽'], availableSizes: [260, 270, 280, 290], images: ['/uploads/shoe38_1.png', '/uploads/shoe38_2.png'], description: '트리 파이퍼(Tree Piper)는 클래식 로우탑 디자인을 재해석한 따뜻한 날씨에 적합한 데일리 캐주얼 스니커즈입니다.' }
    ];
